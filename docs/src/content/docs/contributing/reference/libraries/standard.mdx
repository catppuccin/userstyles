...
The standard library is a collection of mixins to simplify and prevent redundant code in userstyles. In userstyles, the standard library is imported at the top like so (along with other [library modules](/contributing/reference/libraries/modules/)):
