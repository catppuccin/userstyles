...
| --------------------------------------------------------------------------------- | ------------------------------------------------ | -------------- |
| v1 <Badge text="Latest" variant="success" style={{ marginLeft: '0.5rem' }} />      | [`lib/lib.less`](https://github.com/catppuccin/userstyles/blob/main/lib/lib.less) | https://userstyles.catppuccin.com/lib/lib.less |
